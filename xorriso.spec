...
Source0  : https://mirrors.kernel.org/gnu/xorriso/xorriso-1.5.4.tar.gz
Source1  : https://mirrors.kernel.org/gnu/xorriso/xorriso-1.5.4.tar.gz.sig
...
%prep
%setup -q -n xorriso-1.5.4
cd %{_builddir}/xorriso-1.5.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1612201357
...
cp %{_builddir}/xorriso-1.5.4/COPYING %{buildroot}/usr/share/package-licenses/xorriso/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/xorriso-1.5.4/COPYRIGHT %{buildroot}/usr/share/package-licenses/xorriso/431ac668b8e0901320f42864b3f9361854690ff2
cp %{_builddir}/xorriso-1.5.4/libburn/COPYRIGHT %{buildroot}/usr/share/package-licenses/xorriso/a640a4b001c62a6f231213c9e10d5b985b05288b
cp %{_builddir}/xorriso-1.5.4/libisoburn/COPYRIGHT %{buildroot}/usr/share/package-licenses/xorriso/90b747e2b215f2b36d0186df7f5d4d1553800e9a
cp %{_builddir}/xorriso-1.5.4/libisofs/COPYRIGHT %{buildroot}/usr/share/package-licenses/xorriso/2236b80df839204a4250cd722f9f2178c77b387a
cp %{_builddir}/xorriso-1.5.4/xorriso/COPYRIGHT %{buildroot}/usr/share/package-licenses/xorriso/90b747e2b215f2b36d0186df7f5d4d1553800e9a
%make_install
